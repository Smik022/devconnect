...
{
    // List my interviews (as employer or developer)
    public function index()
    {
        ...
        $developers = User::where('role','Developer')->orderBy('name')->limit(50)->get(['id','name']);
    ...
    public function ics(\App\Models\Interview $interview)
    {
    ...
    public function update(Request $request, Interview $interview)
    {
        $data = $request->validate([
            'developer_id' => 'required|exists:users,id|role:Developer',
            'job_post_id'  => 'nullable|exists:job_posts,id',
            'title'        => 'required|string|max:255',
            'type'         => 'required|in:interview,meeting,milestone',
            'location'     => 'nullable|string|max:255',
